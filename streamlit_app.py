...
with col1:
    st.page_link("LCR.py", label="📊 LCR")
    st.page_link("EVE.py", label="📈 EVE")
    st.page_link("MNI.py", label="📊 MNI")
with col2:
    st.page_link("NSFR.py", label="🏦 NSFR")
    st.page_link("RISQUE_DE_CHANGE.py", label="💱 Risque de change")
